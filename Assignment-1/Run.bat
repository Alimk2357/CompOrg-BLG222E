...
::Instruction Memory Unit Simulation
call xvlog ../InstructionRegister.v  
call xvlog ../InstructionMemory.v
call xvlog ../InstructionMemoryUnit.v
call xvlog ../InstructionMemoryUnitSimulation.v
call xvlog ../Helper.v
call xelab -top InstructionMemoryUnitSimulation -snapshot imusim -debug typical
call xsim imusim -R
...
::Data Memory Unit Simulation
call xvlog ../DataRegister.v  
call xvlog ../DataMemory.v
call xvlog ../DataMemoryUnit.v
call xvlog ../DataMemoryUnitSimulation.v
call xvlog ../Helper.v
call xelab -top DataMemoryUnitSimulation -snapshot dmusim -debug typical
call xsim dmusim -R
